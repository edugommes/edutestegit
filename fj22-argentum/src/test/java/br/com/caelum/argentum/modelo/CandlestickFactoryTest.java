...
public class CandlestickFactoryTest {
	...
	public void precoMaximoNaoPodeSerMenorQueMinimo(){
		  ...
		  assertEquals(40.5, candle.getAbertura(), 0.00001);
		  assertEquals(40.7, candle.getFechamento(), 0.00001);
		  assertEquals(40.5, candle.getMinimo(), 0.00001);
		  assertEquals(40.7, candle.getMaximo(), 0.00001);
		  assertEquals(12190.0, candle.getVolume(), 0.00001);		
	}
	...
	public void naoPermiteConstruirCandlesComNegociacoesForaDeOrdem(){
		...
		Calendar dez2099 = (Calendar) hoje.clone();

			dez2099.add(Calendar.MONTH, 12);
			dez2099.add(Calendar.DAY_OF_MONTH, 31);
			dez2099.add(Calendar.YEAR, 2099);
		  
		  Negociacao negociacao4 = new Negociacao(42.3, 100, dez2099);
